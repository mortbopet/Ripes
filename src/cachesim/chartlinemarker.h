...
private:
  /**
   * @brief m_snapToLine
   * If true, the center of the marker will snap to the closest x-axis point on
   * the passed QLineSeries object. Note: it is assumed that the points in the
   * series are in a sorted order!
   */
