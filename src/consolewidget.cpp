...
ConsoleWidget::ConsoleWidget(QWidget *parent)
    : QWidget(parent), m_ui(new Ui::ConsoleWidget) {
  m_ui->setupUi(this);

  connect(m_ui->clearConsoleButton, &QPushButton::clicked, m_ui->console,
...
ConsoleWidget::~ConsoleWidget() { delete m_ui; }

void ConsoleWidget::putData(const QByteArray &d) { m_ui->console->putData(d); }
...
QString ConsoleWidget::getText() const {
  ...
  qWarning(
      "ConsoleWidget::getText() called but UI or console pointer is null.");
  return QString();
}
