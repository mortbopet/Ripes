...
public:
    ...
    void execute() {
        int result =
            SystemIO::seek(BaseSyscall::getArg(RegisterFileType::GPR, 0), BaseSyscall::getArg(RegisterFileType::GPR, 1),
...
public:
    ...
    void execute() {
        const int byteAddress =
            BaseSyscall::getArg(RegisterFileType::GPR, 0);  // destination of characters read from file
        int index = 0;
