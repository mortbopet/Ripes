...
public:
    ...
    void execute() {
        ...
        BaseSyscall::setRet(0, cycleCount & 0xFFFFFFFF);
        BaseSyscall::setRet(1, (cycleCount >> 32) & 0xFFFFFFFF);
    }
};
...
public:
    ...
    void execute() {
        ...
        BaseSyscall::setRet(0, ms & 0xFFFFFFFF);
        BaseSyscall::setRet(1, (ms >> 32) & 0xFFFFFFFF);
    }
};
