...
struct SymbolMap {
    ...
    std::optional<Error> addAbsSymbol(const unsigned& line, const Symbol& s, VInt v);
    ...
    /// Returns a copy of this symbol map with relative symbols copied relative to 'line'.
    /// Relative symbols may be suffixed with additional strings in cases of being before/after the provided source
    /// line.
    AbsoluteSymbolMap copyRelativeTo(unsigned line, const QString& beforeSuffix = "b",
