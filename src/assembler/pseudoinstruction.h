...
//  /**
//   * @brief reg() and imm() return dummy register and immediate expected
//   tokens
//   * for a pseudo instruction. Does not relate to actual regs/imms in an
//   * instruction word, but solely used for a pseudoinstruction to be used
//   within
...
// template <typename Reg_T>
// using PseudoInstrVec =
// std::vector<std::shared_ptr<PseudoInstruction<Reg_T>>>;
