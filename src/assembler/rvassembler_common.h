...
//       Imm<Reg_T>::SymbolType::None) : Imm<Reg_T>(tokenIndex, width, repr,
//       parts, symbolType) {}
// };
...
//   RVInstrITypeBase(RVISA::OpcodeID opcode, const Token &name, unsigned
//   funct3,
...
//                       unsigned funct3, unsigned funct7, const ISAInfoBase
//                       *isa)
...
//                       unsigned funct3, unsigned funct6, const ISAInfoBase
//                       *isa)
//       : RVInstruction<Reg_T>(RVOpcode<Reg_T>(name, opcode,
//                                              RVOpPartFunct3(funct3),
//                                              RVOpPartFunct6(funct6)),
...
//   RVInstrRTypeBase(const Token &name, RVISA::OpcodeID opcode, unsigned
//   funct3,
...
//       : RVInstruction<Reg_T>(
//             RVOpcode<Reg_T>(name, RVISA::OpcodeID::JALR,
//             RVOpPartFunct3(0b000)), {std::make_shared<RVRegRd<Reg_T>>(isa,
//             1),
//              std::make_shared<RVRegRs1<Reg_T>>(isa, 2),
//              std::make_shared<RVImmI<Reg_T>>(3)}) {}
// };
...
//             [=](const PseudoInstruction<Reg_T> &, const TokenizedSrcLine
//             &line,
//                 const SymbolMap &) {
//               LineTokensVec v;
...
/////
///// The sw is a pseudo-op if a symbol is given as the immediate token. Thus,
///if
...
//// The following macros assumes that ASSEMBLER_TYPES(..., ...) has been
///defined / for the given assembler.

// #define RegTok _PseudoInstruction::reg()
// #define ImmTok _PseudoInstruction::imm()
// #define Create_PseudoInstruction
// #d efin e _PseudoExpandFuncSyms(line, symbols) \
