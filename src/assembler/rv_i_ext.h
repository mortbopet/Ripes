...
//    // clang-format off
//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(new
//    _PseudoInstruction(
//        Token("la"), {RegTok, ImmTok}, _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens() << Token("auipc") <<
//            line.tokens.at(1) << Token(line.tokens.at(2), "%pcrel_hi"),
//                                 LineTokens() << Token("addi") <<
//                                 line.tokens.at(1) << line.tokens.at(1) <<
//                                 Token(QString("(%1 +
//                                 4)").arg(line.tokens.at(2)), "%pcrel_lo")};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(new
//    _PseudoInstruction(
//        Token("call"), {ImmTok}, _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens() << Token("auipc") << Token("x1")
//            << Token(line.tokens.at(1), "%pcrel_hi"),
//                                 LineTokens() << Token("jalr") << Token("x1")
//                                 << Token("x1") << Token(QString("(%1 +
//                                 4)").arg(line.tokens.at(1)), "%pcrel_lo")};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(new
//    _PseudoInstruction(
//        Token("tail"), {ImmTok}, _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens() << Token("auipc") << Token("x6")
//            << Token(line.tokens.at(1), "%pcrel_hi"),
//                                 LineTokens() << Token("jalr") << Token("x0")
//                                 << Token("x6") << Token(QString("(%1 +
//                                 4)").arg(line.tokens.at(1)), "%pcrel_lo")};
//        })));
...
//            return LineTokensVec{LineTokens() << Token("jal") << Token("x0")
//            << line.tokens.at(1)};
//        })));
...
//            return LineTokensVec{LineTokens() << Token("jalr") << Token("x0")
...
//            return LineTokensVec{LineTokens() << Token("jalr") << Token("x1")
//            << line.tokens.at(1) << Token("0")};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(new
//    _PseudoInstruction(
//        Token("ret"), {}, [](const _PseudoInstruction&, const
//        TokenizedSrcLine& , const SymbolMap&) {
//            return LineTokensVec{LineTokens() << Token("jalr") << Token("x0")
//            << Token("x1") << Token("0")};
//        })));
...
//            return LineTokensVec{LineTokens() << Token("jal") << Token("x1")
//            << line.tokens.at(1)};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token(Token("nop")), {}, [](const
//        _PseudoInstruction&, const TokenizedSrcLine& , const SymbolMap&) {
//            return LineTokensVec{LineTokens() << Token("addi") << Token("x0")
//            << Token("x0") << Token("0")};
//        })));
...
//            return LineTokensVec{LineTokens{Token("addi"), line.tokens.at(1),
//            line.tokens.at(2), Token("0")}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("not"), {RegTok, RegTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("xori"), line.tokens.at(1),
//            line.tokens.at(2), Token("-1")}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("neg"), {RegTok, RegTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("sub"), line.tokens.at(1),
//            Token("x0"), line.tokens.at(2)}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("seqz"), {RegTok, RegTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("sltiu"), line.tokens.at(1),
//            line.tokens.at(2), Token("1")}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("snez"), {RegTok, RegTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{ LineTokens{Token("sltu"), line.tokens.at(1),
//            Token("x0"), line.tokens.at(2)}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("sltz"), {RegTok, RegTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("slt"), line.tokens.at(1),
//            line.tokens.at(2), Token("x0")}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("sgtz"), {RegTok, RegTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("slt"), line.tokens.at(1),
//            Token("x0"), line.tokens.at(2)}};
//        })));
...
//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("beqz"), {RegTok, ImmTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("beq"), line.tokens.at(1),
//            Token("x0"), line.tokens.at(2)}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("bnez"), {RegTok, ImmTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("bne"), line.tokens.at(1),
//            Token("x0"), line.tokens.at(2)}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("blez"), {RegTok, ImmTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("bge"), Token("x0"),
//            line.tokens.at(1), line.tokens.at(2)}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("bgez"), {RegTok, ImmTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("bge"), line.tokens.at(1),
//            Token("x0"), line.tokens.at(2)}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("bltz"), {RegTok, ImmTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("blt"), line.tokens.at(1),
//            Token("x0"), line.tokens.at(2)}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("bgtz"), {RegTok, ImmTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("blt"), Token("x0"),
//            line.tokens.at(1), line.tokens.at(2)}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("bgt"), {RegTok, RegTok, ImmTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("blt"), line.tokens.at(2),
//            line.tokens.at(1), line.tokens.at(3)}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("ble"), {RegTok, RegTok, ImmTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("bge"), line.tokens.at(2),
//            line.tokens.at(1), line.tokens.at(3)}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("bgtu"), {RegTok, RegTok, ImmTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("bltu"), line.tokens.at(2),
//            line.tokens.at(1), line.tokens.at(3)}};
//        })));

//    pseudoInstructions.push_back(std::shared_ptr<_PseudoInstruction>(
//        new _PseudoInstruction(Token("bleu"), {RegTok, RegTok, ImmTok},
//        _PseudoExpandFunc(line) {
//            return LineTokensVec{LineTokens{Token("bgeu"), line.tokens.at(2),
//            line.tokens.at(1), line.tokens.at(3)}};
//        })));
//    // clang-format on
...
//          int64_t immediate = getImmediateSext32(line.tokens.at(2),
//          canConvert);

//          if (!canConvert) {
//            auto absSymbols = symbols.copyRelativeTo(line.sourceLine());
//            // Check if the immediate has been made available in the symbol
//            set
//            // at this point...
...
//                    line,
//                    QString("Invalid immediate
//                    '%1'").arg(line.tokens.at(2)))};
//              }
//            }
//          }
...
//           * For more insight, please refer to there, since their comments
//           have
...
//                res.push_back(LineTokens() << Token("slli") <<
//                line.tokens.at(1)
//                                           << line.tokens.at(1)
