...
public:
    ...
    static void enableExtF(const ISAInfoBase* isa, _InstrVec& instructions, _PseudoInstrVec& pseudoInstructions);
...
template <typename Reg__T, typename Instr__T>
void RV32I_Assembler::extI<Reg__T, Instr__T>::enable(const ISAInfoBase* isa, _InstrVec& instructions,
...
void RV32I_Assembler::extM<Reg_T, Instr_T>::enable(const ISAInfoBase* isa, _InstrVec& instructions, _PseudoInstrVec&) {
    // Pseudo-op functors
    // --
