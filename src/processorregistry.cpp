...
static void add32And64BitVariations(
    ProcClassInfo &procClassInfo,
    const char *varName,
    const char *varDesc,
    const ID_t variationID32,
  ...
  procClassInfo.addVariation(
    std::make_unique<ProcVariationInfo<ProcType<uint32_t>>>(
      ...
      VariationInfo{ variationID32, baseVariationOptions, VariationInfo::BIT_WIDTH_32 },
  ...
  procClassInfo.addVariation(
    std::make_unique<ProcVariationInfo<ProcType<uint64_t>>>(
      QString(varName), QString(varDesc), 
      VariationInfo{ variationID64, baseVariationOptions, VariationInfo::BIT_WIDTH_64 },
      layouts, defaultRegVals
    )
  );
}
...
static ProcClassInfo register_rv_ss() {
  ...
  ProcClassInfo rv_ss_info(
    ProcessorID::RV_SS, ISA::RV32I, QStringLiteral("Single-cycle RISC-V"), Variations::RV_SS::RV32I
  );
  ...
  add32And64BitVariations<vsrtl::core::RVSS>(
    ...
    Variations::RV_SS::RV32I, Variations::RV_SS::RV64I,
    {},
    layouts, defaultRegVals
  );
  ...
  add32And64BitVariations<vsrtl::core::RVSS_FLOAT>(
    rv_ss_info,
    "Single-cycle floating point processor",
    "A single cycle floating point processor",
    Variations::RV_SS::RV32F, Variations::RV_SS::RV64F,
    {},
    layouts, defaultRegVals
  );
...
static ProcClassInfo register_rv_mc() {
  ...
  ProcClassInfo rv_mc_info(
    ProcessorID::RV_5MC, ISA::RV32I, QStringLiteral("Multi-cycle RISC-V"), Variations::RV_5MC::RV32I_1M
  );
  ...
  add32And64BitVariations<vsrtl::core::RV5MC1M>(
    rv_mc_info,
    "Multi-cycle processor with one memory",
    rv5mc_desc_1m,
    Variations::RV_5MC::RV32I_1M, Variations::RV_5MC::RV64I_1M,
    {},
    layouts, defaultRegVals
  );
  ...
  add32And64BitVariations<vsrtl::core::RV5MC2M>(
    rv_mc_info,
    "Multi-cycle processor with separate memories",
    rv5mc_desc,
...
static ProcClassInfo register_rv_5s() {
  ...
  ProcClassInfo rv5s_info(
    ProcessorID::RV_5S, ISA::RV32I, QStringLiteral("5-Stage RISC-V"), Variations::RV_5S::RV32I_FU_HU
  );
  ...
  add32And64BitVariations<vsrtl::core::RV5S_NO_FW_HZ>(
    ...
    rv5s_no_fw_hz_desc,
    Variations::RV_5S::RV32I, Variations::RV_5S::RV64I,
    {},
    layouts, defaultRegVals
  );

  //------------------------------------------------------------------------------
  // RISC-V 5-stage with floating point unit without forwarding or hazard detection
  //------------------------------------------------------------------------------
  layouts = {
      {"Standard",
       ":/layouts/RISC-V/rv5s_float_no_fw_hz/rv5s_float_no_fw_hz_standard_layout.json",
       {{{0, 0}, QPointF{0.08, 0}},
        {{0, 1}, QPointF{0.35, 0}},
        {{0, 2}, QPointF{0.60, 0}},
        {{0, 3}, QPointF{0.76, 0}},
        {{0, 4}, QPointF{0.90, 0}}}},
      {"Extended",
       ":/layouts/RISC-V/rv5s_float_no_fw_hz/rv5s_float_no_fw_hz_extended_layout.json",
       {{{0, 0}, QPointF{0.08, 0.0}},
  ...
  add32And64BitVariations<vsrtl::core::RV5S_FLOAT_NO_FW_HZ>(
    ...
    rv5s_float_no_fw_hz_desc,
    Variations::RV_5S::RV32F, Variations::RV_5S::RV64F,
    {},
    layouts, defaultRegVals
  );
  ...
  add32And64BitVariations<vsrtl::core::RV5S_NO_FW>(
    ...
    rv5s_no_fw_desc,
    Variations::RV_5S::RV32I_HU, Variations::RV_5S::RV64I_HU,
    { option_Hazard },
    layouts, defaultRegVals
  );
  ...
  add32And64BitVariations<vsrtl::core::RV5S>(
    ...
    { option_Hazard, option_Forwarding },
    layouts, defaultRegVals
  );
...
static ProcClassInfo register_rv_6s() {
  ...
  ProcClassInfo rv6s_info(
    ProcessorID::RV_6S_DUAL, ISA::RV32I, QStringLiteral("6-Stage Dual-Issue RISC-V"), Variations::RV_6S_DUAL::RV32I
  );
  ...
  add32And64BitVariations<vsrtl::core::RV6S_DUAL>(
    ...
    rv6s_desc,
    Variations::RV_6S_DUAL::RV32I, Variations::RV_6S_DUAL::RV64I,
    {},
    layouts, defaultRegVals
  );
