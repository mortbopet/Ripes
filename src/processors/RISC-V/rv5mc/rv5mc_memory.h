...
class RVMCMemory : public Component, public BaseMemory<true> {
public:
  SetGraphicsType(ClockedComponent);
  RVMCMemory(const std::string &name, SimComponent *parent)
  ...
  // RVMCMemory is also a BaseMemory... A bit redundant, but RVMCMemory has a notion
