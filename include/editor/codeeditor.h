...
signals:
   ...
   * Using m_changeTimer, timedTextChanged will be emitted whenever the user has
   * stopped editing the text document for some time. The signal may be used as
   * an alternative to QPlainTextEdit::textChanged(), to reduce the amount of
   * updates performed wrt. text changes.
   */
...
private:
  ...
  /**
   * @brief keyPressEvent
   * We override the key press event to provide any editor quality of life
